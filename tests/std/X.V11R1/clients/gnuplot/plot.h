/* $Header: plot.h,v 1.1 87/09/11 08:20:30 toddb Exp $ */
/*
 *
...
/* the file from which the documentation is read. */
#define HELP_INFO_FILE "/orpheus/u1/gnuplot/docs/gnuplot.info"
...
#define TERM "egalib"
#else /* PC */
#define TERM "xwindow"	    /* put your most common term type here! */
#endif /* PC */
...
#define MAX_ID_LEN 255	    /* max length of an identifier */
...
/* The end of the terminal table is marked by having a null pointer
   in the terminal name slot.  TERM_IS_GOOD(n) should return true for
   all terminal slots before that one. */
#define TERM_IS_GOOD(n) (term_tbl[n].name != NULL)
...
struct termentry {
	...
	ulput_text, tickmark_text, point;
};
