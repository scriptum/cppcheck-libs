/* $Header: term.c,v 1.1 87/09/11 08:20:40 toddb Exp $ */
/*
 *
...
%%!\n\
/off {36 add} def\n\
/mv {off exch off moveto} def\n\
/ln {off exch off lineto} def\n\
/xlabel {dup stringwidth pop -14 exch 2 div neg exch rmoveto show} def\n\
/ylabel {dup stringwidth pop 5 add neg -4 rmoveto show} def\n\
/initscale {0.8 0.8 scale 90 90 translate 0.25 setlinewidth} def\n\
...
PS_graphics()
{
  (void) fprintf(outfile,"initscale\nnewpath\n") ;
}
...
PS_tickmark_text (str, axis, x, y)
     char *str, axis;
     int x, y;
{
  PS_move (x, y);
  if (axis == 'x' || axis == 'y')
    (void) fprintf (outfile, "(%s) %clabel\n", str, axis);
  else {
    printf ("bad axis name for PS tick label: %c\n", axis);
    abort ();
  }
}
...
#ifdef XWINDOW
extern int xw_init(), xw_reset(), xw_text(), xw_graphics(),
	xw_move(), xw_vector(), xw_linetype(), xw_lrput_text(),
	xw_ulput_text(), xw_tickmark_text();
#endif
...
struct termentry term_tbl[] = {
...
#ifdef PC
    ,{"cga", CGA_XMAX, CGA_YMAX, CGA_VCHAR, CGA_HCHAR, CGA_VTIC,
	CGA_HTIC, CGA_init, CGA_reset, CGA_text, CGA_graphics,
	CGA_move, CGA_vector, CGA_linetype, CGA_lrput_text,
	CGA_ulput_text, UNKNOWN_null, line_and_point}

    ,{"egabios", EGA_XMAX, EGA_YMAX, EGA_VCHAR, EGA_HCHAR, EGA_VTIC,
	EGA_HTIC, EGA_init, EGA_reset, EGA_text, EGA_graphics,
	EGA_move, EGA_vector, EGA_linetype, EGA_lrput_text,
	EGA_ulput_text, UNKNOWN_null, do_point}
	...
	EGALIB_linetype, EGALIB_lrput_text, EGALIB_ulput_text,
	UNKNOWN_null, do_point}
#endif

#ifdef HERCULES
    ,{"hercules", HERC_XMAX, HERC_YMAX, HERC_VCHAR, HERC_HCHAR,
	HERC_VTIC, HERC_HTIC, HERC_init, HERC_reset, HERC_text,
	HERC_graphics, HERC_move, HERC_vector, HERC_linetype,
	HERC_lrput_text, HERC_ulput_text, UNKNOWN_null,
	line_and_point}
#endif /* HERCULES */

#ifdef ATT6300
    ,{"att", ATT_XMAX, ATT_YMAX, ATT_VCHAR, ATT_HCHAR, ATT_VTIC,
	ATT_HTIC, ATT_init, ATT_reset, ATT_text, ATT_graphics,
	ATT_move, ATT_vector, ATT_linetype, ATT_lrput_text,
	ATT_ulput_text, UNKNOWN_null, line_and_point}
#endif

#ifdef CORONA
    ,{"corona325", COR_XMAX, COR_YMAX, COR_VCHAR, COR_HCHAR, COR_VTIC,
	COR_HTIC, COR_init, COR_reset, COR_text, COR_graphics,
	COR_move, COR_vector, COR_linetype, COR_lrput_text,
	COR_ulput_text, UNKNOWN_null, line_and_point}
#endif /* CORONA */
#endif /* PC */

#ifdef AED
    ,{"aed512", AED5_XMAX, AED_YMAX, AED_VCHAR, AED_HCHAR, AED_VTIC,
	AED_HTIC, AED_init, AED_reset, AED_text, AED_graphics,
	AED_move, AED_vector, AED_linetype, AED5_lrput_text,
	AED_ulput_text, UNKNOWN_null, do_point}
    ,{"aed767", AED_XMAX, AED_YMAX, AED_VCHAR, AED_HCHAR, AED_VTIC,
	AED_HTIC, AED_init, AED_reset, AED_text, AED_graphics,
	AED_move, AED_vector, AED_linetype, AED_lrput_text,
	AED_ulput_text, UNKNOWN_null, do_point}
#endif

#ifdef BITGRAPH
    ,{"bitgraph",BG_XMAX,BG_YMAX,BG_VCHAR, BG_HCHAR, BG_VTIC, BG_HTIC,
	BG_init,BG_reset, BG_text, BG_graphics, BG_move,
	BG_vector,BG_linetype,BG_lrput_text, BG_ulput_text,
	UNKNOWN_null, line_and_point}
#endif

#ifdef HP26
    ,{"hp2623A",HP26_XMAX,HP26_YMAX, HP26_VCHAR,
	HP26_HCHAR,HP26_VTIC,HP26_HTIC,
	HP26_init,HP26_reset,HP26_text, HP26_graphics, HP26_move,
	HP26_vector, HP26_linetype, HP26_lrput_text, HP26_ulput_text,
	UNKNOWN_null, line_and_point}
#endif

#ifdef HP75
    ,{"hp7580B",HP75_XMAX,HP75_YMAX, HP75_VCHAR,
	HP75_HCHAR,HP75_VTIC,HP75_HTIC,
	HP75_init,HP75_reset,HP75_text, HP75_graphics, HP75_move,
	HP75_vector, HP75_linetype, HP75_lrput_text, HP75_ulput_text,
	UNKNOWN_null, do_point}
#endif

#ifdef POSTSCRIPT
    ,{"postscript", PS_XMAX, PS_YMAX, PS_VCHAR, PS_HCHAR, PS_VTIC,
	PS_HTIC, PS_init, PS_reset, PS_text, PS_graphics, PS_move,
	PS_vector, PS_linetype, PS_lrput_text, PS_ulput_text,
	PS_tickmark_text, line_and_point}
#endif

#ifdef QMS
    ,{"qms",QMS_XMAX,QMS_YMAX, QMS_VCHAR, QMS_HCHAR, QMS_VTIC,
	QMS_HTIC, QMS_init,QMS_reset, QMS_text, QMS_graphics,
	QMS_move, QMS_vector, QMS_linetype, QMS_lrput_text,
	QMS_ulput_text, UNKNOWN_null, line_and_point}
#endif

#ifdef REGIS
    ,{"regis", REGISXMAX, REGISYMAX, REGISVCHAR, REGISHCHAR,
	REGISVTIC, REGISHTIC, REGISinit, REGISreset, REGIStext,
	REGISgraphics, REGISmove,REGISvector,REGISlinetype,
	REGISlrput_text, REGISulput_text, UNKNOWN_NULL,
	line_and_point}
#endif
	...
	TEK40ulput_text, UNKNOWN_null, line_and_point}
#endif
...
#ifdef UNIXPLOT
    ,{"unixplot", UP_XMAX, UP_YMAX, UP_VCHAR, UP_HCHAR, UP_VTIC,
	UP_HTIC, UP_init, UP_reset, UP_text, UP_graphics, UP_move,
	UP_vector, UP_linetype, UP_lrput_text, UP_ulput_text,
	UNKNOWN_null, line_and_point}
#endif
	...
	V384_ulput_text, UNKNOWN_null, do_point}
#endif

#ifdef XWINDOW
    /* all the zeroed items in this entry are screen and font size
       parameters, which will be filled in by the xw_init routine */
    ,{"xwindow", 0, 0, 0, 0, 0, 0,
        xw_init, xw_reset, xw_text, xw_graphics, xw_move, xw_vector,
        xw_linetype, xw_lrput_text, xw_ulput_text, xw_tickmark_text,
	line_and_point}
#endif
